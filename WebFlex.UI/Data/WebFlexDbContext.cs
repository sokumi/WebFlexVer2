...
public class WebFlexDbContext : BaseDbContext {
    ...
    private static void ApplySystemSeedData(ModelBuilder modelBuilder, DateTime createdAt) {
        ...
        modelBuilder.Entity<SMenu>().HasData(
            ...
            new SMenu { ID = "DASH_CARD", PARENT_MENU_ID = "DASHBOARD", MENU_CODE = "DASHBOARD.CARD", MENU_NAME = "CARD", URL = "/main/card", ICON = "panel-top", SORT_ORDER = 12, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            ...
            new SMenu { ID = "DEVICE_GROUP", PARENT_MENU_ID = "DEVICE", MENU_CODE = "DEVICE.GROUP", MENU_NAME = "그룹 관리", CONTROLLER_NAME = "Device", ACTION_NAME = "DVC2000", URL = "/device/dvc2000", ICON = "folder-tree", SORT_ORDER = 33, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            ...
            new SMenu { ID = "OPTIONS", MENU_CODE = "OPTIONS", MENU_NAME = "OPTIONS", ICON = "sliders-horizontal", SORT_ORDER = 60, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            new SMenu { ID = "OPTION_COLLECT", PARENT_MENU_ID = "OPTIONS", MENU_CODE = "OPTIONS.COLLECTOR", MENU_NAME = "Collector 옵션", CONTROLLER_NAME = "Opc", ACTION_NAME = "OPC1020", URL = "/opc/opc1020", ICON = "settings-2", SORT_ORDER = 61, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            new SMenu { ID = "OPTION_CLIENT", PARENT_MENU_ID = "OPTIONS", MENU_CODE = "OPTIONS.CLIENT", MENU_NAME = "Client 옵션", CONTROLLER_NAME = "Opc", ACTION_NAME = "OPC1030", URL = "/opc/opc1030", ICON = "plug", SORT_ORDER = 62, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            new SMenu { ID = "OPTION_HISTORY", PARENT_MENU_ID = "OPTIONS", MENU_CODE = "OPTIONS.HISTORY", MENU_NAME = "History 조회", CONTROLLER_NAME = "Opc", ACTION_NAME = "OPC3000", URL = "/opc/opc3000", ICON = "history", SORT_ORDER = 63, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt },
            new SMenu { ID = "OPTION_TSD", PARENT_MENU_ID = "OPTIONS", MENU_CODE = "OPTIONS.TIMESCALE", MENU_NAME = "Timescale 설정", CONTROLLER_NAME = "Opc", ACTION_NAME = "OPC4000", URL = "/opc/opc4000", ICON = "database-zap", SORT_ORDER = 64, SHOW_IN_MENU = true, IsEnabled = true, CreatedAt = createdAt }
        );

        var roleMenus = new List<SRoleMenu>();
        var seq = 1;

        AddRoleMenus(roleMenus, ref seq, allRoles, new[] {
        "DASHBOARD", "DASH_MAIN", "DASH_CARD",
        "SERVICE", "SERVICE_DATA", "SERVICE_TREND"
    }, createdAt);

        AddRoleMenus(roleMenus, ref seq, new[] { "DevAuth", "WebflexUser", "TestAuth" }, new[] {
        "DEVICE", "DEVICE_MANAGE", "DEVICE_TAG", "DEVICE_GROUP"
    }, createdAt);

        AddRoleMenus(roleMenus, ref seq, new[] { "DevAuth", "TestAuth" }, new[] {
        "OPC", "OPC_COLLECT",
        "SYSTEM", "SYSTEM_SVC",
        "OPTIONS", "OPTION_COLLECT", "OPTION_CLIENT", "OPTION_HISTORY", "OPTION_TSD"
    }, createdAt);
