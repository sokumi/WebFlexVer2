...
class Page {
    ...
    init() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnToggleLogs").on("click", () => this.toggleLogs());
    ...
    async loadDevices() {
        ...
        try {
            ...
            if (!result.success) {
                this.devices = [];
                this.renderDeviceError((_a = result.message) !== null && _a !== void 0 ? _a : "디바이스 조회 실패");
                return;
            }
            this.devices = ((_b = result.data) !== null && _b !== void 0 ? _b : []).map((x) => this.normalizeDeviceRow(x));
        }
        catch (e) {
            console.error(e);
            this.devices = [];
    ...
    async loadStatus() {
        ...
        try {
            ...
            const version = (_b = (_a = data.collectorVersion) !== null && _a !== void 0 ? _a : data.version) !== null && _b !== void 0 ? _b : "-";
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblSnapshotTime").text(`마지막 ${this.getCurrentTimeText()}`);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblCollectorDbStatus").text((_d = data.dbStatus) !== null && _d !== void 0 ? _d : "DB 상태 -");
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblCollectorDbStatus").text("DB 상태 -");
        }
    }
        ...
        await Promise.all(this.devices.map(async (device) => {
            ...
            try {
                ...
                this.deviceStatuses.set(deviceId, {
                    ...
                    tagCount: (_c = device.tagCount) !== null && _c !== void 0 ? _c : 0,
                    runtimeStatus: {
                        subscribedCount: 0,
                        currentValueCount: 0,
    ...
    updateStoppedDeviceCount() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblStoppedCount").text(`${stoppedCount.toLocaleString()}개 구독중지`);
    }
    renderDeviceEmpty() {
    ...
    createEmptyHtml(message) {
        return `
            <article class="wf-opc-empty-card">
                ...
                <strong>${(0,_framework_common__WEBPACK_IMPORTED_MODULE_1__.escapeHtml)(message)}</strong>
    ...
    async postDeviceSubscription(deviceId, action) {
        if (deviceId.length === 0) {
            _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.warning("디바이스 정보가 없습니다.");
            return;
        }
        try {
            ...
            _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.success(action === "start" ? "디바이스 구독 시작 요청 완료" : "디바이스 구독 중지 요청 완료");
            await this.loadStatus();
            await this.loadDeviceSummary();
            await this.loadDeviceCards();
        }
    ...
    clearLogs() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#logBox").empty();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblLogCount").text("0개 항목");
    }
    async loadLogs() {
        try {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblLogCount").text(`${logs.length.toLocaleString()}개 항목`);
        }
        catch (e) {
            console.error(e);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#logBox").html("<div class='wf-opc-log-empty'>로그 조회 실패</div>");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblLogCount").text("0개 항목");
        }
    }
    toggleLogs() {
    ...
    setLogCollapsed(isCollapsed) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#opcLogCard").toggleClass("is-collapsed", isCollapsed);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#lblLogToggleText").text(isCollapsed ? "펼치기" : "접기");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnToggleLogs").attr("aria-expanded", String(!isCollapsed));
        window.dispatchEvent(new CustomEvent("webflex:layoutChanged"));
    }
    ...
    normalizeDeviceRow(row) {
        ...
        return {
            ...row,
            id: (_a = this.readValue(row, "id", "ID", "deviceId", "DEVICE_ID")) !== null && _a !== void 0 ? _a : "",
            deviceCode: (_b = this.readValue(row, "deviceCode", "id", "ID")) !== null && _b !== void 0 ? _b : "",
            deviceName: (_c = this.readValue(row, "deviceName", "DEVICE_NAME")) !== null && _c !== void 0 ? _c : "",
            deviceType: (_d = this.readValue(row, "deviceType", "DEVICE_TYPE")) !== null && _d !== void 0 ? _d : "",
            endpointUrl: (_e = this.readValue(row, "endpointUrl", "ENDPOINT_URL")) !== null && _e !== void 0 ? _e : "",
            deviceAddress: (_f = this.readValue(row, "deviceAddress", "DEVICE_ADDRESS")) !== null && _f !== void 0 ? _f : "",
            port: this.readValue(row, "port", "PORT"),
            tagCount: (_g = this.readNumber(row, "tagCount", "TAG_COUNT")) !== null && _g !== void 0 ? _g : 0,
