...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WebFlexGrid: () => (/* binding */ WebFlexGrid)
/* harmony export */ });
...
/***/ "./Scripts/src/ts/views/test/tst2010.ts"
/*!**********************************************!*\
  !*** ./Scripts/src/ts/views/test/tst2010.ts ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class Page {
    ...
    bindEvents() {
        $("#selDevice").on("change", () => {
            ...
            this.selectedTagIds = [];
            this.renderNodes();
            void ((_b = this.selectedNodeGrid) === null || _b === void 0 ? void 0 : _b.setData([]));
            void ((_c = this.tagGrid) === null || _c === void 0 ? void 0 : _c.setData([]));
    ...
    initSelectedNodeGrid() {
        this.selectedNodeGrid = new _framework_grid_webflexGrid__WEBPACK_IMPORTED_MODULE_1__.WebFlexGrid({
    ...
    initTagGrid() {
        this.tagGrid = new _framework_grid_webflexGrid__WEBPACK_IMPORTED_MODULE_1__.WebFlexGrid({
            selector: "#gridTag",
            height: 380,
            pagination: true,
            paginationSize: 10,
        ...
        $("#gridTag").on("change", ".wf-tag-check", event => {
            var _a;
            const id = String((_a = $(event.currentTarget).data("id")) !== null && _a !== void 0 ? _a : "");
    ...
    async loadDevices() {
        ...
        try {
            ...
            if (!result.success || result.data == null) {
                this.showAlert((_a = result.message) !== null && _a !== void 0 ? _a : "디바이스 조회에 실패했습니다.");
                return;
            }
            ...
            for (const device of this.devices) {
                ...
                $sel.append(`<option value="${this.escapeHtml(device.id)}">${this.escapeHtml(device.deviceName)} (${this.escapeHtml(device.deviceType)} / ${collectText})</option>`);
            }
        }
        catch (e) {
    ...
    async browse() {
        ...
        try {
            ...
            if (!result.success || result.data == null) {
                this.showAlert((_a = result.message) !== null && _a !== void 0 ? _a : "노드 조회에 실패했습니다.");
                return;
            }
            ...
            this.selectedNodes = [];
            this.renderNodes();
            await ((_b = this.selectedNodeGrid) === null || _b === void 0 ? void 0 : _b.setData([]));
            this.updateSelectedCount();
    ...
    async loadTags() {
        ...
        try {
            const keyword = encodeURIComponent(String((_a = $("#txtTagKeyword").val()) !== null && _a !== void 0 ? _a : "").trim());
            ...
            if (!result.success || result.data == null) {
                this.showAlert((_b = result.message) !== null && _b !== void 0 ? _b : "태그 조회에 실패했습니다.");
                return;
            }
            this.selectedTagIds = [];
            await ((_c = this.tagGrid) === null || _c === void 0 ? void 0 : _c.setData(result.data));
    ...
    toggleNode(node, checked) {
        ...
        void ((_a = this.selectedNodeGrid) === null || _a === void 0 ? void 0 : _a.setData(this.selectedNodes));
        this.updateSelectedCount();
    }
    selectAllVariableNodes() {
        var _a;
    ...
    clearSelectedNodes() {
        ...
        this.selectedNodes = [];
        this.renderNodes();
        void ((_a = this.selectedNodeGrid) === null || _a === void 0 ? void 0 : _a.setData([]));
        this.updateSelectedCount();
    }
    async save() {
        var _a, _b;
        ...
        try {
            ...
            if (!result.success) {
                this.showAlert((_a = result.message) !== null && _a !== void 0 ? _a : "태그 저장에 실패했습니다.");
                return;
            }
            this.showAlert((_b = result.message) !== null && _b !== void 0 ? _b : "태그가 저장되었습니다.");
            this.clearSelectedNodes();
            await this.loadTags();
            await this.loadSummary();
        }
    ...
    toggleTagSelection(id) {
        ...
        (_a = this.tagGrid) === null || _a === void 0 ? void 0 : _a.instance.redraw(true);
    }
    selectAllTags() {
        var _a, _b;
        const rows = (_a = this.tagGrid) === null || _a === void 0 ? void 0 : _a.instance.getSelectedData();
        if (rows.length > 0) {
        ...
        (_b = this.tagGrid) === null || _b === void 0 ? void 0 : _b.instance.redraw(true);
    }
    clearSelectedTags() {
        var _a;
        this.selectedTagIds = [];
    ...
    async deleteTags() {
        ...
        try {
            ...
            if (!result.success) {
                this.showAlert((_a = result.message) !== null && _a !== void 0 ? _a : "태그 삭제에 실패했습니다.");
                return;
            }
            this.showAlert((_b = result.message) !== null && _b !== void 0 ? _b : "태그가 삭제되었습니다.");
            this.selectedTagIds = [];
            await this.loadTags();
            await this.loadSummary();
        }
...
/*!****************************************************!*\
  ...
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_ts_views_test_tst2010__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../src/ts/views/test/tst2010 */ "./Scripts/src/ts/views/test/tst2010.ts");
...
(0,_src_ts_framework_page__WEBPACK_IMPORTED_MODULE_1__.runPage)(_src_ts_views_test_tst2010__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
(() => {
/*!************************************************!*\
  !*** ./Scripts/src/css/views/test/tst2010.css ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
