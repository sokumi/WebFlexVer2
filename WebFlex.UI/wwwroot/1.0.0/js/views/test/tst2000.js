...
/***/ "./Scripts/src/ts/views/test/tst2000.ts"
/*!**********************************************!*\
  !*** ./Scripts/src/ts/views/test/tst2000.ts ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class Page {
    ...
    getFormData() {
        ...
        return {
            ...
            deviceAddress: String((_c = $("#txtDeviceAddress").val()) !== null && _c !== void 0 ? _c : "").trim(),
            port: Number((_d = $("#txtPort").val()) !== null && _d !== void 0 ? _d : 0),
            endpointUrl: String((_e = $("#txtEndpointUrl").val()) !== null && _e !== void 0 ? _e : "").trim(),
            ...
            userName: String((_f = $("#txtUserName").val()) !== null && _f !== void 0 ? _f : "").trim(),
    ...
    async previewEndpoint() {
        var _a, _b, _c, _d;
        const deviceType = encodeURIComponent(String((_a = $("#selDeviceType").val()) !== null && _a !== void 0 ? _a : ""));
        const address = encodeURIComponent(String((_b = $("#txtDeviceAddress").val()) !== null && _b !== void 0 ? _b : "").trim());
        const port = Number((_c = $("#txtPort").val()) !== null && _c !== void 0 ? _c : 0);
        try {
            const result = await _framework_common__WEBPACK_IMPORTED_MODULE_0__.api.get({
    ...
    applyEndpointPlaceholder() {
        var _a, _b, _c;
        const deviceType = String((_a = $("#selDeviceType").val()) !== null && _a !== void 0 ? _a : "");
        const address = String((_b = $("#txtDeviceAddress").val()) !== null && _b !== void 0 ? _b : "").trim();
        const port = Number((_c = $("#txtPort").val()) !== null && _c !== void 0 ? _c : 0);
...
var __webpack_exports__ = {};
/*!****************************************************!*\
  !*** ./Scripts/.generated/views__test__tst2000.ts ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_ts_views_test_tst2000__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../src/ts/views/test/tst2000 */ "./Scripts/src/ts/views/test/tst2000.ts");
...
(0,_src_ts_framework_page__WEBPACK_IMPORTED_MODULE_1__.runPage)(_src_ts_views_test_tst2000__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
(() => {
/*!************************************************!*\
  !*** ./Scripts/src/css/views/test/tst2000.css ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
...
/******/ })()
;
//# sourceMappingURL=tst2000.js.map