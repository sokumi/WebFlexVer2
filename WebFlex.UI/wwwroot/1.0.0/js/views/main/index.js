...
class Page {
    ...
    init() {
        ...
        window.addEventListener("beforeunload", () => {
            ...
            (_c = (_b = this.grid) === null || _b === void 0 ? void 0 : _b.destroy) === null || _c === void 0 ? void 0 : _c.call(_b);
        });
    }
    initGrid() {
        var _a, _b, _c, _d;
        ...
        this.grid = new tabulator_tables__WEBPACK_IMPORTED_MODULE_0__.TabulatorFull(host, {
            index: "rowKey",
            height: "100%",
            layout: "fitColumns",
            reactiveData: false,
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: (cell) => {
                        ...
                        const value = (_b = (_a = row.groupName) !== null && _a !== void 0 ? _a : row.groupId) !== null && _b !== void 0 ? _b : "-";
                        return `<span class="wf-current-group-text" title="${this.escapeHtml((_c = row.groupId) !== null && _c !== void 0 ? _c : "")}">${this.escapeHtml(value)}</span>`;
                    }
                },
                {
                    title: "태그 ID",
                ...
                },
                {
                    ...
                    width: 120,
                    hozAlign: "right",
                    formatter: (cell) => this.escapeHtml(this.formatNumber(cell.getValue()))
                },
                {
                    title: "Source Time",
                    field: "sourceTimestamp",
                    minWidth: 165,
                    formatter: (cell) => this.escapeHtml(this.formatDate(cell.getValue()))
                },
                {
                    title: "Updated Time",
                    field: "updatedAt",
            ...
            rowFormatter: (row) => {
                ...
                element.setAttribute("data-key", (_a = data.rowKey) !== null && _a !== void 0 ? _a : "");
            },
            renderComplete: () => {
                this.bindGridScroll();
        ...
        (_b = (_a = this.grid) === null || _a === void 0 ? void 0 : _a.on) === null || _b === void 0 ? void 0 : _b.call(_a, "tableBuilt", () => {
            this.onGridReady();
        });
        (_d = (_c = this.grid) === null || _c === void 0 ? void 0 : _c.on) === null || _d === void 0 ? void 0 : _d.call(_c, "scrollVertical", () => {
    ...
    onGridReady() {
        ...
        const holder = document.querySelector("#currentValueGrid .tabulator-tableholder");
        if (holder == null) {
            window.setTimeout(() => {
                this.onGridReady();
            }, 30);
    ...
    bindEvents() {
        ...
        window.addEventListener("resize", () => {
            var _a, _b;
            (_b = (_a = this.grid) === null || _a === void 0 ? void 0 : _a.redraw) === null || _b === void 0 ? void 0 : _b.call(_a, true);
            this.updateVisibleRange();
        });
    }
    bindGridScroll() {
    ...
    async loadGroups() {
        ...
        try {
            ...
            this.groupRows = (_a = result.data) !== null && _a !== void 0 ? _a : [];
    ...
    renderGroups(groups) {
        ...
        const total = groups.reduce((sum, item) => { var _a; return sum + Number((_a = item.count) !== null && _a !== void 0 ? _a : 0); }, 0);
        const html = [];
        html.push(`
            <button type="button"
        ...
        for (const group of groups) {
            ...
            html.push(`
                <button type="button"
                    ...
                    <span>${Number((_c = group.count) !== null && _c !== void 0 ? _c : 0).toLocaleString()}</span>
                    ${Number((_d = group.badCount) !== null && _d !== void 0 ? _d : 0) > 0 ? `<em>${Number((_e = group.badCount) !== null && _e !== void 0 ? _e : 0).toLocaleString()}</em>` : ""}
                </button>
            `);
        }
        ...
        $("#lblGroupSummary").text(this.selectedGroupId.length === 0
            ? "전체 그룹"
            : (_f = selected === null || selected === void 0 ? void 0 : selected.groupName) !== null && _f !== void 0 ? _f : this.selectedGroupId);
        this.refreshIcons();
    }
    selectGroup(groupId) {
        var _a;
    ...
    async loadNextPage(seq = this.reloadSeq) {
        ...
        try {
            ...
            const page = (_a = result.data) !== null && _a !== void 0 ? _a : {};
            const pageRows = ((_b = page.rows) !== null && _b !== void 0 ? _b : []).map((x) => this.normalizeCurrentRow(x));
            const newRows = [];
            this.totalCount = Number((_c = page.totalCount) !== null && _c !== void 0 ? _c : 0);
            ...
            if (this.rows.length === 0) {
                await ((_e = (_d = this.grid) === null || _d === void 0 ? void 0 : _d.replaceData) === null || _e === void 0 ? void 0 : _e.call(_d, []));
            }
        }
        finally {
            if (seq === this.reloadSeq) {
    ...
    applyUpdate(row) {
        ...
        const isRendered = document.querySelector(`#currentValueGrid .tabulator-tableholder [data-key="${this.escapeSelectorValue(key)}"]`) != null;
        if (!isRendered) {
            return;
        }
        ...
        const patched = this.patchRowCells(key, {
            value: `<span class="wf-current-value" title="${this.escapeHtml((_b = existing.value) !== null && _b !== void 0 ? _b : "")}">${this.escapeHtml((_c = existing.value) !== null && _c !== void 0 ? _c : "-")}</span>`,
            cookieValue: `<span class="wf-current-cookie-value" title="${this.escapeHtml((_d = existing.cookieValue) !== null && _d !== void 0 ? _d : "")}">${this.escapeHtml((_e = existing.cookieValue) !== null && _e !== void 0 ? _e : "-")}</span>`,
    ...
    patchRowCells(key, patches) {
        var _a, _b;
        const row = (_b = (_a = this.grid) === null || _a === void 0 ? void 0 : _a.getRow) === null || _b === void 0 ? void 0 : _b.call(_a, key);
    ...
    isMatchedCurrentFilter(row) {
        ...
        return String((_b = row.collectionSetting) !== null && _b !== void 0 ? _b : "").toLowerCase().includes(q) ||
            ...
            String((_d = row.groupName) !== null && _d !== void 0 ? _d : "").toLowerCase().includes(q) ||
            String((_e = row.tagId) !== null && _e !== void 0 ? _e : "").toLowerCase().includes(q) ||
            String((_f = row.value) !== null && _f !== void 0 ? _f : "").toLowerCase().includes(q) ||
            String((_g = row.cookieValue) !== null && _g !== void 0 ? _g : "").toLowerCase().includes(q);
    }
    triggerFlash(key) {
        var _a, _b;
        const row = (_b = (_a = this.grid) === null || _a === void 0 ? void 0 : _a.getRow) === null || _b === void 0 ? void 0 : _b.call(_a, key);
    ...
    normalizeCurrentRow(row) {
        ...
        const tagId = String((_a = this.readValue(row, "tagId", "TAG_ID", "tag_id")) !== null && _a !== void 0 ? _a : "");
        const key = this.makeKey(groupId, tagId);
        return {
            ...row,
            rowKey: key,
            groupId,
            groupName: (_b = this.readValue(row, "groupName", "GROUP_NAME", "group_name")) !== null && _b !== void 0 ? _b : this.getGroupDisplayName(groupId),
            tagId,
    ...
    getGroupDisplayName(groupId) {
        var _a;
        const id = String(groupId !== null && groupId !== void 0 ? groupId : "");
        if (id.length === 0) {
            return "";
        }
        const group = this.groupRows.find((x) => { var _a; return String((_a = x.groupId) !== null && _a !== void 0 ? _a : "") === id; });
        return String((_a = group === null || group === void 0 ? void 0 : group.groupName) !== null && _a !== void 0 ? _a : id);
    }
    readValue(row, ...names) {
        if (row == null) {
            return null;
    ...
    makeKey(groupId, tagId) {
        return `${groupId !== null && groupId !== void 0 ? groupId : ""}||${tagId !== null && tagId !== void 0 ? tagId : ""}`;
    }
    formatDate(value) {
        if (value == null || value === "") {
            return "-";
