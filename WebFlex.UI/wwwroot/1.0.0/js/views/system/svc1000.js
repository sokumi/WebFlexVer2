...
class Page {
    ...
    init() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnRefresh").on("click", () => {
            void this.loadStatus(true);
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnInstall").on("click", () => {
            void this.installService();
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnStart").on("click", () => {
            void this.post("/system/service/start", "서비스 시작 요청이 완료되었습니다.");
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnStop").on("click", () => {
            void this.post("/system/service/stop", "서비스 중지 요청이 완료되었습니다.");
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnRestart").on("click", () => {
            void this.restartService();
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnUninstall").on("click", () => {
            void this.uninstallService();
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnToggleLog").on("click", () => {
            this.toggleLog();
        });
    ...
    async loadStatus(showToast = false) {
        ...
        try {
            ...
            if (!result.success || result.data == null) {
                throw new Error((_a = result.message) !== null && _a !== void 0 ? _a : "서비스 상태 조회에 실패했습니다.");
            }
            ...
            if (showToast) {
                _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.success("서비스 상태를 조회했습니다.");
            }
            ...
            this.writeError(e);
            if (showToast) {
                _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.error("서비스 상태 조회에 실패했습니다.");
            }
        }
    }
    renderStatus(data) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceStatus").text(this.getStatusText(data));
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceHeroCard")
            .removeClass("is-running is-stopped is-not-installed is-error is-unknown")
            .addClass(`is-${visualStatus}`);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceStatusBadge")
            .removeClass("is-running is-stopped is-not-installed is-error is-unknown")
            .addClass(`is-${visualStatus}`);
    }
    renderErrorStatus() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceStatus").text("조회 실패");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceHeroCard")
            .removeClass("is-running is-stopped is-not-installed is-error is-unknown")
            .addClass("is-error");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceStatusBadge")
    ...
    async post(url, successMessage = null) {
        ...
        try {
            ...
            this.writeResult(result);
            if (!result.success) {
                _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.error((_a = result.message) !== null && _a !== void 0 ? _a : "요청 처리에 실패했습니다.");
            }
            else {
                _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.success((_c = (_b = result.message) !== null && _b !== void 0 ? _b : successMessage) !== null && _c !== void 0 ? _c : "요청 처리 완료");
            }
            await this.loadStatus();
        }
        catch (e) {
            console.error(e);
            _framework_notify__WEBPACK_IMPORTED_MODULE_2__.notify.error("요청 처리 중 오류가 발생했습니다.");
            this.writeError(e);
        }
    }
    ...
    setButtonState(data) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnInstall").prop("disabled", !isNotInstalled);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnStart").prop("disabled", !exists || isRunning);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnStop").prop("disabled", !exists || isStopped || isNotInstalled);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnRestart").prop("disabled", !exists || isNotInstalled);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnUninstall").prop("disabled", !exists || isRunning);
    }
    toggleLog() {
    ...
    setLogCollapsed(isCollapsed) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceLogCard").toggleClass("is-collapsed", isCollapsed);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceLogToggleText").text(isCollapsed ? "펼치기" : "접기");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnToggleLog").attr("aria-expanded", String(!isCollapsed));
        window.dispatchEvent(new CustomEvent("webflex:layoutChanged"));
    }
    writeResult(data) {
        const text = JSON.stringify(data, null, 2);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#resultBox").text(text);
